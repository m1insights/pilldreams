      ...
      <div className="mt-20  grid cols-1 lg:grid-cols-5 gap-4 auto-rows-[25rem] max-w-3xl mx-auto lg:max-w-none">
        <Card className="flex flex-col relative justify-between lg:col-span-2">
          ...
          <CardContent className="h-40 absolute bottom-0">
            ...
            <CardDescription>
              Identify novel epigenetic regulators (Writers, Readers, Erasers) with strong biological validation.
            </CardDescription>
          </CardContent>
        </Card>
        <Card className="flex relative flex-col justify-between lg:col-span-3">
          <CardContent className="h-40">
            <CardTitle>
              Weighted <br /> Scoring Model
            </CardTitle>
            <CardDescription>
              Prioritize assets using our proprietary scoring engine based on Biology, Chemistry, and Tractability.
            </CardDescription>
          </CardContent>
        ...
        <Card className="flex flex-col relative justify-between lg:col-span-3">
          ...
          <CardContent className="h-40 relative mb-4">
            <CardTitle>
              Comprehensive <br /> Data Coverage
            </CardTitle>
            <CardDescription>
              Access a gold standard set of approved therapies to benchmark experimental assets.
            </CardDescription>
          </CardContent>
        ...
        <Card className="flex flex-col justify-between lg:col-span-2">
          <CardContent className="h-40">
            <CardTitle>
              Trusted by <br /> Researchers
            </CardTitle>
            <CardDescription>
              Empowering biotech analysts and oncology researchers to make data-driven decisions.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
...
const CARDS = [
  {
    ...
    content: (
      <p>
        This platform has revolutionized how we <Highlight>prioritize targets</Highlight>. The scoring model is incredibly robust.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        I use this daily to <Highlight>screen assets</Highlight>. The integration of Open Targets and ChEMBL data is seamless.
      </p>
    ),
  },
  {
    id: 2,
    name: "Sarah L.",
    designation: "Medicinal Chemist",
    content: (
      <p>
        The <Highlight>ChemScore</Highlight> metrics are exactly what I needed to assess potency and selectivity quickly.
      </p>
    ),
  },
];
